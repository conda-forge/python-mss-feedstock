...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-mss-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10165&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-mss-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-mss` can be installed with:

```
conda install python-mss
```

It is possible to list all of the versions of `python-mss` available on your platform with:
